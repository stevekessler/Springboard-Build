...
projects[sbsetup][download][branch] = 7.x-4.6.1
...
projects[springboard_themes][download][branch] = 7.x-4.6.1
...
projects[springboard][download][branch] = 7.x-4.x-72-create-new-form-layout
...
projects[encrypt][patch][] = https://raw.github.com/JacksonRiver/Springboard-Build/7.x-4.x-72-create-new-form-layout/patches/encrypt-trim-only-decrypted-output.patch
