...
projects[sbsetup][download][branch] = 7.x-4.6
...
projects[springboard_themes][download][branch] = 7.x-4.6
...
projects[springboard][download][branch] = 7.x-4.6.1-beta
...
projects[encrypt][patch][] = https://raw.github.com/JacksonRiver/Springboard-Build/7.x-4.6.1-beta/patches/encrypt-trim-only-decrypted-output.patch
