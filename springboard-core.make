...
projects[springboard_themes][download][branch] = 7.x-4.9.x-recurring-ask-amounts-mtsb
...
projects[springboard][download][branch] = 7.x-4.8.x-recurring-ask-amounts-mtsb
...
projects[encrypt][patch][] = https://raw.github.com/JacksonRiver/Springboard-Build/7.x-4.9.x-recurring-ask-amounts-mtsb/patches/encrypt-trim-only-decrypted-output.patch
