...
projects[sbsetup][download][branch] = 7.x-4.x-677-warning-on-ticketed-event-submission
...
projects[springboard_themes][download][branch] = 7.x-4.x-677-warning-on-ticketed-event-submission
...
projects[springboard][download][branch] = 7.x-4.x-677-warning-on-ticketed-event-submission
...
projects[encrypt][patch][] = https://raw.github.com/JacksonRiver/Springboard-Build/7.x-4.x-677-warning-on-ticketed-event-submission/patches/encrypt-trim-only-decrypted-output.patch
