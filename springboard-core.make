...
projects[springboard_themes][download][branch] = 7.x-4.x-admin_ui-path-aliasing-with-subpaths
...
projects[springboard][download][branch] = cs-288-7.x-4.4.1-subpath-fix
