...
projects[sbsetup][download][branch] = 7.x-4.8.2-beta
...
projects[springboard_themes][download][branch] = 7.x-4.8.2-beta
...
projects[springboard][download][branch] = 7.x-4.x-666-currency-prefix-for-ticket-donation-additional-amount
...
projects[encrypt][patch][] = https://raw.github.com/JacksonRiver/Springboard-Build/7.x-4.8.2-dma-test/patches/encrypt-trim-only-decrypted-output.patch
